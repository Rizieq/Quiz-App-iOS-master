...
class QuizVC: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    override func viewDidLoad() {
        ...
        let que1 = Question(imgName: "mark", questionText: "Siapakah nama orang di atas ?", options: ["Steve Job", "Mark Zukembrug", "Bill Gate", "Yusril Nurhadi"], correctAns: 1, wrongAns: -1, isAnswered: false)
        let que2 = Question(imgName: "proton", questionText: "Siapakah nama orang foto orang diatas ? \n clue: proton", options: ["Jhon Dalton", "Niels Bohr", "Max Plan", "Ernest Rutherford"], correctAns: 3, wrongAns: -1, isAnswered: false)
        let que3 = Question(imgName: "Niels", questionText: "Siapa nama orang di atas ? \n clue: atom", options: ["Mark Wezniak", "Albert Antonio", "Niels Bohr", "Max plan"], correctAns: 2, wrongAns: -1, isAnswered: false)
        let que4 = Question(imgName: "thomas", questionText: "Siapakah nama orang diatas ? \n clue: Listrik", options: ["Roy Bolward", "Eindels", "Roy Bilward", "Michael Faraday"], correctAns: 3, wrongAns: -1, isAnswered: false)
        let que5 = Question(imgName: "Steve", questionText: "Siapakah orang diatas ?\nclue: Apple", options: ["Steve Jobs", "Bill Gates", "Wenderlick", "Laurene Powell"], correctAns: 0, wrongAns: -1, isAnswered: false)
        let que6 = Question(imgName: "jawed", questionText: "Siapakah orang diatas ?\nclue: Youtube", options: ["Tim Cook", "Elon Musk", "Jawed Karim", "Larry Page"], correctAns: 2, wrongAns: -1, isAnswered: false)
         let que7 = Question(imgName: "guglielmo", questionText: "Siapakah orang diatas ?\nclue: Radio", options: ["Tim Cook", "Elon Musk", "Guglielmo Marconi", "Larry Page"], correctAns: 2, wrongAns: -1, isAnswered: false)
        let que8 = Question(imgName: "philo", questionText: "Siapakah nama orang di atas ?", options: ["Steve Job", "Philo Farssforth", "Bill Gate", "Pick Wiliam"], correctAns: 1, wrongAns: -1, isAnswered: false)
        questionsArray = [que1, que2, que3, que4, que5, que6, que7, que8]
